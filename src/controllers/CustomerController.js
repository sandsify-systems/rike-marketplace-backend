...
var CustomerController = /** @class */ (function () {
    ...
    CustomerController.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, customerService.getAll()];
                    case 1:
                        customers = _a.sent();
                        res.json(customers);
                        return [2 /*return*/];
    ...
    CustomerController.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, customerService.getById(Number(req.params.id))];
                    case 1:
                        customer = _a.sent();
                        if (!customer) {
    ...
    CustomerController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, customerService.create(req.body)];
                    case 1:
                        customer = _a.sent();
                        res.json(customer);
                        return [2 /*return*/];
    ...
    CustomerController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, customerService.update(Number(req.params.id), req.body)];
                    case 1:
                        customer = _a.sent();
                        if (!customer) {
                            return [2 /*return*/, res.status(404).json({ message: 'Customer not found' })];
    ...
    CustomerController.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, customerService.delete(Number(req.params.id))];
                    case 1:
                        _a.sent();
                        res.sendStatus(204);
                        return [2 /*return*/];
