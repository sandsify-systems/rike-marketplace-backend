...
var OrderController = /** @class */ (function () {
    ...
    OrderController.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderService.getAll()];
                    case 1:
                        orders = _a.sent();
                        res.json(orders);
                        return [2 /*return*/];
    ...
    OrderController.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderService.getById(Number(req.params.id))];
                    case 1:
                        order = _a.sent();
                        if (!order) {
    ...
    OrderController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderService.create(req.body)];
                    case 1:
                        order = _a.sent();
                        res.json(order);
                        return [2 /*return*/];
    ...
    OrderController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderService.update(Number(req.params.id), req.body)];
                    case 1:
                        order = _a.sent();
                        if (!order) {
                            return [2 /*return*/, res.status(404).json({ message: 'Order not found' })];
    ...
    OrderController.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderService.delete(Number(req.params.id))];
                    case 1:
                        _a.sent();
                        res.sendStatus(204);
                        return [2 /*return*/];
